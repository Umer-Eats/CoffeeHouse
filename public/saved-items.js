...
window.SavedItems = {
  ...
  download(doc) {
    ...
    const html = '<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
      '<title>' + esc(doc.title) + '</title><style>@page{margin:0.75in}body{max-width:7in;margin:0 auto;padding:0;font:12pt/1.5 Georgia,serif;color:#222}h1{font-size:18pt;margin:0 0 6pt}pre{white-space:pre-wrap;font:10pt/1.4 monospace;background:#f7f5f0;padding:10px;border:1px solid #ddd}table{border-collapse:collapse;width:100%}td,th{border:1px solid #aaa;padding:5px 8px;font-size:10pt}blockquote{border-left:3px solid #b99a74;padding-left:12px;color:#555}a{color:#59411f}</style>' +
      '<body><h1>' + esc(doc.title) + '</h1>' + content.innerHTML + '</body></html>';
