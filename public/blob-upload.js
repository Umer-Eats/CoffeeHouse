/* Vercel Blob client-direct upload — lightweight browser helper.
   Uploads files straight to Vercel Blob (bypasses the server payload limit).
...
(function () {
  ...
  async function uploadToBlob(file, opts) {
    ...
    /* Step 2 — PUT the file directly to Vercel Blob */
  ...
  window.VercelBlob = { upload: uploadToBlob };
})();
