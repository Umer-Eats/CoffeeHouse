...
- [Wizard-UI-style.md](Wizard-UI-style.md): pixel-art design system, themes, responsive layouts, and interaction patterns.

Run `npm run dev` for the app and `npm test` for page checks.
